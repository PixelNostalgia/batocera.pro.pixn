...
# --------------------------------------------------------------------
# -- prepare Ports file, 
port=/userdata/system/pro/$appname/xcloud.sh 
...
if [[ ! -s "$keys" ]]; then
  wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O "$keys" "https://raw.githubusercontent.com/PixelNostalgia/batocera.pro.pixn/main/xcloud/extra/xcloud.sh.keys"
