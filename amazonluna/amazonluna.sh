...
# --------------------------------------------------------------------
depurl=https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/.dep
...
cd $temp
tar -xf $temp/*.tar.xz
mv $temp/amazonluna/* $pro/$appname/
cd $pro
rm -rf $temp
...
# --------------------------------------------------------------------
# get icon
extra=https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/$appname/extra
...
# --------------------------------------------------------------------
# -- prepare Ports file, 
port="/userdata/roms/ports/AmazonLuna.sh" 
rm "$port" 2>/dev/null
echo '#!/bin/bash ' >> $port
