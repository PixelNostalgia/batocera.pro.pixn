...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME=XARCHIVER # for installer info
appname=xarchiver # directory name in /userdata/system/pro/...
AppName=xarchiver # App.AppImage name
APPPATH=/userdata/system/pro/$appname/$appname.AppImage
APPLINK=http://batocera.pro/app/$appname.AppImage
ORIGIN=batocera.pro@github.com/ib/xarchiver # credit & info
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
