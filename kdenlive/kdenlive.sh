...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME="KDENLIVE" # for installer info
appname=kdenlive # directory name in /userdata/system/pro/...
AppName=Kdenlive # App.AppImage name
APPPATH=/userdata/system/pro/$appname/$AppName.AppImage
APPLINK=$(curl https://kdenlive.org/en/download/ | grep AppImage | sed 's,^.*href=,,g' | cut -d " " -f1 | sed 's,",,g')
ORIGIN="OFFICIAL KDENLIVE.ORG APPIMAGE" # credit & info
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
...
######################################################################
######################################################################
echo 'mkdir /userdata/system/pro/'$appname'/home 2>/dev/null; mkdir /userdata/system/pro/'$appname'/config 2>/dev/null; LD_LIBRARY_PATH="/userdata/system/pro/.dep:${LD_LIBRARY_PATH}" DISPLAY=:0.0 HOME=/userdata/system/pro/'$appname'/home XDG_CONFIG_HOME=/userdata/system/pro/'$appname'/config QT_SCALE_FACTOR="0.5" GDK_SCALE="0.5" /userdata/system/pro/'$appname'/'$AppName'.AppImage 2>/dev/null' >> $launcher
######################################################################
######################################################################
######################################################################
######################################################################
