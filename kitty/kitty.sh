...
######################################################################
APPNAME="KITTY" # for installer info
...
APPLINK=https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/kitty/extra/kitty-0.26.5-x86_64.txz
...
######################################################################
######################################################################
echo 'LD_LIBRARY_PATH="/userdata/system/pro/.dep:${LD_LIBRARY_PATH}" DISPLAY=:0.0 QT_SCALE_FACTOR="1.25" GDK_SCALE="1.25" /userdata/system/pro/kitty/bin/kitty ~/ 2>/dev/null' >> $launcher
######################################################################
######################################################################
######################################################################
######################################################################
