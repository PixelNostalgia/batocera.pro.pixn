...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME=GTHUMB # for installer info
appname=gthumb # directory name in /userdata/system/pro/...
AppName=gthumb # App.AppImage name
APPPATH=/userdata/system/pro/$appname/$appname.AppImage
APPLINK=http://batocera.pro/app/$appname.AppImage
ORIGIN=batocera.pro@github.com/GNOME/gthumb # credit & info
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
