...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME="SAYONARA" # for installer info
appname=sayonara # directory name in /userdata/system/pro/...
AppName=Sayonara # App.AppImage name
APPPATH=/userdata/system/pro/$appname/$AppName.AppImage
APPLINK="https://sayonara-player.com/files/appimage/$(curl https://sayonara-player.com/files/appimage/ | grep AppImage | grep stable | tail -n 1 | sed 's,^.*href=,,g' | cut -d ">" -f1 | sed 's,",,g')"
ORIGIN="OFFICIAL SAYONARA-PLAYER APPIMAGE" # credit & info
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
