...
#       DEFINE APP INFO >>
APPNAME=greenlight 
APPLINK=https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/greenlight/extra/Greenlight-2.0.0-beta4.AppImage
...
echo '#!/bin/bash ' >> $port
echo 'DISPLAY=:0.0 /userdata/system/pro/'$appname'/Launcher "$@"' >> $port
dos2unix $port 
chmod a+x $port 
