...
apps=(
    ...
    ["ANDROID/BLISS-OS/DOCKER/QEMU"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/bliss_install.sh | bash" 
    ["ANTIMICROX"]="curl -Ls antimicrox.batocera.pro | bash"
    ["APPIMAGE-PARSER"]="curl -Ls appimage.batocera.pro | bash"
    ["APPLEWIN/WINE"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/applewin/applewin.sh | bash"
    ...
    ["CASAOS/CONTAINER/DEBIAN/XFCE"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/casa.sh | bash"
    ...
    ["DOCKER"]="curl -Ls  https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/install.sh | bash"    
    ...
    ["EMBY/DOCKER"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/emby.sh | bash"
    ...
    ["JELLYFIN/DOCKER"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/jellyfin.sh | bash"
    ...
    ["LINUX-DESKTOPS-RDP/DOCKER"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/rdesktop.sh | bash"
    ["LINUX-VMS-ON-QEMU/DOCKER"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/qemu.sh | bash"
    ...
    ["MINECRAFT-BEDROCK-EDITION"]="curL -Ls https://raw.githubusercontent.com/PixelNostalgia/batocera.pro.pixn/main/bedrock/bedrock.sh"
    ...
    ["NEXTCLOUD/DOCKER"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/nextcloud.sh | bash" 
    ...
    ["PLEX/DOCKER"]="curl -L https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/plex.sh | bash"
    ["PLEXAMP"]="curl -Ls plexamp.batocera.pro | bash"
    ["POKEMMO"]="curl -Ls pokemmo.batocera.pro | bash"
    ["PORTAINER/DOCKER"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/install.sh | bash"
    ...
    ["SABNZBD/DOCKER"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/sabnzbd.sh | bash"
    ["SAK"]="curl -Ls sak.batocera.pro | bash"
    ["SAYONARA"]="curl -Ls sayonara.batocera.pro | bash"
    ["SHEEPSHAVER"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/sheepshaver/install.sh | bash"
    ...
    ["WINDOWS-VMS/DOCKER"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/docker/win.sh | bash"
    ["WINE-CUSTOM-DOWNLOADER/v40+"]="curl -Ls https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/wine-custom/wine.sh | bash"
    ["WINE-MANAGER"]="curl -Ls winemanager.batocera.pro | bash"
    ["WPS-OFFICE"]="curl -Ls wps.batocera.pro | bash"
