#!/usr/bin/env bash 
######################################################################
# BATOCERA.PRO/MINECRAFT-BEDROCK EDITION INSTALLER
######################################################################
APPNAME="MINECRAFT BEDROCK EDITION" # for installer info
appname=bedrock   # directory name in /userdata/system/pro/...
AppName=bedrock   # App.AppImage name
APPPATH=/userdata/system/pro/$appname/$appname.AppImage
APPLINK=https://github.com/minecraft-linux/appimage-builder/releases/download/v0.15.0-795/Minecraft_Bedrock_Launcher-bookworm-x86_64-v0.15.0.795.AppImage
...
wget https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/bedrock/shortcut/Minecraft-Bedrock.sh -O /userdata/roms/ports/Minecraft-Bedrock.sh > /dev/null 2>&1 && chmod +x /userdata/roms/ports/Minecraft-Bedrock.sh > /dev/null 2>&1
echo "DONE"
sleep 3
