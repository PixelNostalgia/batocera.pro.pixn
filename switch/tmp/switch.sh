...
wget -q -O "$path/batocera-switch-updater.sh" "https://raw.githubusercontent.com/PixelNostalgia/batocera.pro.pixn/main/tmp/switch/update.sh"
...
wget -q -O "/tmp/batocera-switch-updater.sh" "https://github.com/PixelNostalgia/batocera.pro.pixn/raw/main/switch/tmp/update.sh" 
