...
echo
echo -e "${X}$APPNAME WILL BE AVAILABLE IN PORTS AND F1->APPLICATIONS "
...
wget -q -O $pad2key https://raw.githubusercontent.com/PixelNostalgia/batocera.pro.pixn/main/qdirstat/extra/QDirStat.sh.keys
# -- done. 
sleep 1
echo -e "${G}> ${W}DONE"
echo
